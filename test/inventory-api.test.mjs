...
const controller=await readFile(new URL('../backend/api/src/modules/inventory/public/inventory.controller.ts',import.meta.url),'utf8');
const service=await readFile(new URL('../backend/api/src/modules/inventory/public/inventory-application.service.ts',import.meta.url),'utf8');
const lifecycle=await readFile(new URL('../backend/database/migrations/0007_phase4_reservation_lifecycle.sql',import.meta.url),'utf8');
